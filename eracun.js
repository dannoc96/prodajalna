...
streznik.post('/izpisiRacunBaza', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka, polja, datoteke){
    var stRac = polja.seznamRacunov;
    strankaIzRacuna(stRac, function(napaka1, stranka){
      pesmiIzRacuna(stRac, function(napaka2, pesmi) {
    ...
    if (!pesmi) {
      ...
      vrniStranke(function(napaka, stranke) {
        ...
        odgovor.render('eslog', {
          ...
          postavkeRacuna: pesmi,
          stranka: stranke[zahteva.session.str-1]
        })
      });
    }
  })
...
streznik.post('/stranka', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    zahteva.session.str = polja.seznamStrank;
    odgovor.redirect('/')
  });
})
